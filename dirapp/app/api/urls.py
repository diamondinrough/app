...
#   url(r'^app/users/', views.UserListView.as_view(), name='api-user-list-view'),
    ...
    url(r'^app/task/(?P<id>[0-9]+)/join', views.TaskJoin.as_view()),
    url(r'^app/task/(?P<id>[0-9]+)/leave', views.TaskLeave.as_view()),
    url(r'^app/task/(?P<id>[0-9]+)/leader', views.TaskLeader.as_view()),
    url(r'^app/task/(?P<id>[0-9]+)/', views.TaskView.as_view()),
    url(r'^app/tasks/create', views.TaskCreate.as_view()),
